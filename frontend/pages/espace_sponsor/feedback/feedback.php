...
<head>
	...
	<title>Feedback | Espace Sponsor</title>
...
<body>
	...
	<header>
		...
		<nav>
			<ul>
				...
				<li>
					<a href="../data/data.php">Espace Sponsor ▾</a>
					<div class="dropdown">
						<a href="../data/data.php">Données</a>
	...
	<main>
		<section class="page-hero">
			<h1>Feedback</h1>
			<p>Base minimale pour recueillir les retours.</p>
		</section>

		<section class="content-block">
			<p>Aucun retour collecté.</p>
		</section>
	</main>
